...
// device
 static NSString * baseUrl = @"http://192.168.86.43:8080";
 static NSString * gdprUrl = @"http://192.168.86.43:8080";
 static NSString * subscriptionUrl = @"http://192.168.86.43:8080";
 static NSString * controlUrl = @"ws://192.168.86.43:1987";
