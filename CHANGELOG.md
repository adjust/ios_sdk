...
#### Added
- Added sending of the aditional parameter to improve troubleshooting of `SKAdNetwork` related issues.

#### Fixed
- Fixed occasional occurences in which ATT waiting interval timer was not being started.
