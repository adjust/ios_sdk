...
then
  ...
  echo -e "${CYAN}[ADJUST][BUILD]:${GREEN} = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =${NC}"
  build_dynamic_fat_framework "${SCHEMA_NAME__ADJUST_IOS}" "ios" "${XCF_FRM_NAME__ADJUST_IOS}" "${XCF_OUTPUT_ROOT_FOLDER}" "${TEMP_OUTPUT_FOLDER}" "${XCF_OUTPUT_FRMK_IOS_FOLDER_DYNAMIC}-framework-${SDK_VERSION}.zip"
else
...
then
  ...
  echo -e "${CYAN}[ADJUST][BUILD]:${GREEN} = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =${NC}"
  build_dynamic_fat_framework "${SCHEMA_NAME__ADJUST_TV}" "tvos" "${XCF_FRM_NAME__ADJUST_TV}" "${XCF_OUTPUT_ROOT_FOLDER}" "${TEMP_OUTPUT_FOLDER}" "${XCF_OUTPUT_FRMK_TV_FOLDER_DYNAMIC}-framework-${SDK_VERSION}.zip"
else
...
then
  ...
  echo -e "${CYAN}[ADJUST][BUILD]:${GREEN} = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =${NC}"
  build_dynamic_fat_framework "${SCHEMA_NAME__ADJUST_IM}" "ios" "${XCF_FRM_NAME__ADJUST_IM}" "${XCF_OUTPUT_ROOT_FOLDER}" "${TEMP_OUTPUT_FOLDER}" "${XCF_OUTPUT_FRMK_IM_FOLDER_DYNAMIC}-framework-${SDK_VERSION}.zip"
else
...
then
  ...
  echo -e "${CYAN}[ADJUST][BUILD]:${GREEN} = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =${NC}"
  build_dynamic_fat_framework "${SCHEMA_NAME__ADJUST_WEB_BRIDGE}" "ios" "${XCF_FRM_NAME__ADJUST_WEB_BRIDGE}" "${XCF_OUTPUT_ROOT_FOLDER}" "${TEMP_OUTPUT_FOLDER}" "${XCF_OUTPUT_FRMK_WEB_BRIDGE_FOLDER_DYNAMIC}-framework-${SDK_VERSION}.zip"
else
...
then
  ...
  echo -e "${CYAN}[ADJUST][BUILD]:${GREEN} = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =${NC}"
  build_dynamic_fat_framework "${SCHEMA_NAME__ODM_DYNAMIC}" "ios" "${XCF_FRM_NAME__ADJUST_ODM}" "${XCF_OUTPUT_ROOT_FOLDER}" "${TEMP_OUTPUT_FOLDER}" "${XCF_OUTPUT_FRMK_ODM_FOLDER_DYNAMIC}-framework-${SDK_VERSION}.zip"
else
