...
then
  ...
  then
    ...
    ARCHIVE_NAME="${XCF_OUTPUT_FRMK_IOS_TV_FOLDER_STATIC}-xcframework-${SDK_VERSION}.zip"
  ...
  then
    ...
    ARCHIVE_NAME="${XCF_OUTPUT_FRMK_IOS_FOLDER_STATIC}-xcframework-${SDK_VERSION}.zip"
  ...
  then
    ...
    ARCHIVE_NAME="${XCF_OUTPUT_FRMK_TV_FOLDER_STATIC}-xcframework-${SDK_VERSION}.zip"
...
then
  ...
  ARCHIVE_NAME="${XCF_OUTPUT_FRMK_IM_FOLDER_STATIC}-xcframework-${SDK_VERSION}.zip"
...
then
  ...
  ARCHIVE_NAME="${XCF_OUTPUT_FRMK_WEB_BRIDGE_FOLDER_STATIC}-xcframework-${SDK_VERSION}.zip"
...
then
  ...
  ARCHIVE_NAME="${XCF_OUTPUT_FRMK_ODM_FOLDER_STATIC}-xcframework-${SDK_VERSION}.zip"
