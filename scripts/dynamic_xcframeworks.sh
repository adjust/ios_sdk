...
then
  ...
  then
    ...
    ARCHIVE_NAME="${XCF_OUTPUT_FRMK_IOS_TV_FOLDER_DYNAMIC}-xcframework-${SDK_VERSION}.zip"
  ...
  then
    ...
    ARCHIVE_NAME="${XCF_OUTPUT_FRMK_IOS_FOLDER_DYNAMIC}-xcframework-${SDK_VERSION}.zip"
  ...
  then
    ...
    ARCHIVE_NAME="${XCF_OUTPUT_FRMK_TV_FOLDER_DYNAMIC}-xcframework-${SDK_VERSION}.zip"
    ARCHIVE_FRAMEWORK_PATH_WITH_PARENT_FOLDER="${XCF_OUTPUT_FRMK_TV_FOLDER_DYNAMIC}-xcframework/${XCF_FRM_NAME__ADJUST_IOS}.xcframework"
    XCFRAMEWORK_OUTPUT_PATH="./${XCF_OUTPUT_ROOT_FOLDER}/${XCF_OUTPUT_DYNAMIC_XCFRMKS_FOLDER}/${ARCHIVE_FRAMEWORK_PATH_WITH_PARENT_FOLDER}"
...
then
  ...
  ARCHIVE_NAME="${XCF_OUTPUT_FRMK_IM_FOLDER_DYNAMIC}-xcframework-${SDK_VERSION}.zip"
...
then
  ...
  ARCHIVE_NAME="${XCF_OUTPUT_FRMK_WEB_BRIDGE_FOLDER_DYNAMIC}-xcframework-${SDK_VERSION}.zip"
...
then
  ...
  ARCHIVE_NAME="${XCF_OUTPUT_FRMK_ODM_FOLDER_DYNAMIC}-xcframework-${SDK_VERSION}.zip"
